...
pub fn Dashboard() -> Element {
    ...
    rsx! {
                 ...
                 div {
                    ...
                    div {
                        ...
                        Subgraph {
                            ...
                            Subgraph {
                                title: your_node.to_string(),
                                id: your_node.to_string(),

                                div {
                                    class: "flex flex-row gap-12 items-center justify-evenly",
                                    Subgraph {
                                        title: "Your VLAD".to_string(),
                                        id: vlad.to_string(),
                                        div {
        ...
        // Subgraph is "Value"
                            ...
                            // Rest of the network Subgraph
                            Subgraph {
                                title: "Other Nodes".to_string(),
                                id: "OtherNodes".to_string(),
                                div {
                                    class: "flex flex-row gap-2 items-center justify-evenly my-2",
                                    input {
                                        class: "border border-gray-300 rounded-lg p-2",
                                        r#type: "text",
                                        placeholder: "Connect to other Nodes"
                                    },
                                }
                                div {
                                    class: "flex flex-col gap-2 items-center justify-evenly",
                                    input {
                                        class: "border border-gray-300 rounded-lg p-2",
                                        r#type: "text",
                                        placeholder: "Search for other Vlads"
                                    },
                                    // Two column grid list of VLad and their Plog head CIDs
                                    // | Buddy | Vlad |  Plog Head Cid |
                                    // Regular html and css, no components
                                    div {
                                        class: "grid grid-cols-3 gap-4 border border-dashed",
                                        div {
                                            class: "font-bold",
                                            "Buddy"
                                        }
